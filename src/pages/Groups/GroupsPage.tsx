  ...
  return (
    <>
      ...
      <Grid container sx={{ m: "0 auto", maxWidth: "1200px" }}>
        ...
        <Grid item xs={12} md={5} lg={5} sx={{ px: 1 }}>
          <Grid
            container
            alignItems="center"
        ...
        {/* Групи */}
        <Grid item xs={12} md={7} lg={7} sx={{ px: 1 }}>
          <Grid container alignItems="center" justifyContent="space-between">
            ...
            <Grid item alignItems="center" sx={{ display: "flex" }}>
              <Typography variant="h5" sx={activeGroupCategory ? { flexGrow: 1 } : { flexGrow: 1, mb: "12px" }}>
                {loadingStatus !== LoadingStatusTypes.LOADING && !activeGroupCategory && "Завантаження..."}
                {activeGroupCategory && activeGroupCategory.name}
              </Typography>
